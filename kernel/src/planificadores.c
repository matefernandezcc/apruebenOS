...
void iniciar_planificadores()
{
    ...
    {
        LOG_DEBUG(kernel_log, "Error al crear hilo para planificador de largo plazo");
    ...
    {
        LOG_DEBUG(kernel_log, "Error al crear hilo para gestionar procesos en EXIT");
        terminar_kernel(EXIT_FAILURE);
    }
    ...
    {
        LOG_DEBUG(kernel_log, "Error al crear hilo para planificador de corto plazo");
        terminar_kernel(EXIT_FAILURE);
    }
    ...
    {
        LOG_DEBUG(kernel_log, "[PLANI LP] [EXIT] Error al crear hilo para verificar procesos rechazados");
        terminar_kernel(EXIT_FAILURE);
    }
...
t_pcb *elegir_por_fifo(t_list *cola_a_utilizar)
{
    ...
    {
        LOG_DEBUG(kernel_log, "[FIFO] cola_a_utilizar vacía");
        return NULL;
    }
